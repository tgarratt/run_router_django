"""
Django settings for run_router_django project.
...
MIDDLEWARE = [
    ...
    'run_router_django.middleware.LogCsrfTokenMiddleware',
...
ROOT_URLCONF = 'run_router_django.urls'
...
WSGI_APPLICATION = 'run_router_django.wsgi.application'
